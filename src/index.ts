...
import { ExamResult } from "./examResult.class";
...
const kishanResult = new ExamResult(kishan.studentId);

// i have created a result object lets put some marks

const mathResult = new SubjectResult(Maths, 80, mathsSubForExam.getMaxMarks());
// lets also addd for other subject science

const scienceResult = new SubjectResult(
  Science,
  90,
  scienceSubForExam.getMaxMarks(),
);


// we have created the results lets add them to the examresult array

kishanResult.addResult(mathResult)
kishanResult.addResult(scienceResult)

console.log(examClass12);

console.log("kishan's result : ",kishanResult)


// lets see other methods tooo

console.log("total marks : ", kishanResult.getTotalMarks())
console.log("total maxMarks : ", kishanResult.getTotalMaxMarks())
console.log("percentage gott :  ", kishanResult.getPercentage())
